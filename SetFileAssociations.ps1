...
Set-FTA -ProgId "ChromeHTML" -Protocol ".html"
Set-FTA -ProgId "ChromeHTML" -Protocol "http"
Set-FTA -ProgId "ChromeHTML" -Protocol "https"
Set-FTA -ProgId "VLC.mov" -Protocol ".mov"
Set-FTA -ProgId "VLC.mp4" -Protocol ".mp4"
Set-FTA -ProgId "Outlook.URL.mailto.15" -Protocol "mailto"