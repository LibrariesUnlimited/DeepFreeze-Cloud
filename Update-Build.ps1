...
$adultApplicationsValues = @{
    "Internet"="C:\Program Files\Google\Chrome\Application\chrome.exe,https://www.ncsc.gov.uk/section/advice-guidance/you-your-family,,130,295,2"
...
Write-Output "END OF NIC SETTINGS"
Write-Output "---------------------"
